...
> 研究日期：2026-07-10；芯片口径校准：2026-07-12<br>
...
> 原调研来源分级与证据对应关系见 `03_source_catalog.csv` 和 `04_evidence_ledger.csv`；本次新增的 25-28 号校准来源直接列于本页，尚未回写旧 CSV 台账。
